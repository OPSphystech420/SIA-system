...
//IMGUI_API void          StyleColorsDragonRoyal(ImGuiStyle* dst = NULL);
IMGUI_API void          StyleColorsDragonBlue(ImGuiStyle* dst = NULL);
//IMGUI_API void          StyleColorsDragonHacker(ImGuiStyle* dst = NULL);
//IMGUI_API void          StyleColorsDarkBlue(ImGuiStyle* dst = NULL);
//IMGUI_API void          StyleColorsDarkLime(ImGuiStyle* dst = NULL);
//IMGUI_API void          StyleColorsDarkness(ImGuiStyle* dst = NULL);
...
struct ImColor
{
    ...
    constexpr ImColor(float rgb[3])    : Value(rgb[0], rgb[1], rgb[2], 1.0f) { }
