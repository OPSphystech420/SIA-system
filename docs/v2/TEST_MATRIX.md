...
| PLAN-G2B-DISCOVERY-001 | 2B | Explicit bounded FNamePool, GUObjectArray and reflection capture only through the provenance reader | Owned known-name/object/reflection snapshots; generation invalidation; zero capabilities | `.1` executed/aborted fail-closed; corrected `.2` repeat pending |
