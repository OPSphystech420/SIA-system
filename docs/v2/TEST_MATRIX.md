...
| PLAN-G2C-RELATIONSHIPS-001 | 2C | Fresh Gate 2B snapshot followed by bounded Engine/GameViewport/World/NetDriver/definition relationships and world-generation invalidation | Exact relationships, same-world generation stability, stale-generation refusal and zero capabilities | two independent generation-1 map captures passed; same-tracker repeat and lifecycle transition pending |
