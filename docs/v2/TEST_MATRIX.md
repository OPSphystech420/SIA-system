...
| PLAN-G2C-RELATIONSHIPS-001 | 2C | Fresh Gate 2B snapshot followed by bounded Engine/GameViewport/World/NetDriver/definition relationships and world-generation invalidation | Exact relationships, menu/map transition, same-world generation stability, stale-generation refusal and zero capabilities | continuous `.6` proves and `.7` independently reproduces replacement + same-world stability; labeled menu transition and visible-regression observation pending |
