...
| PLAN-G2C-RELATIONSHIPS-001 | 2C | Fresh Gate 2B snapshot followed by bounded Engine/GameViewport/World/NetDriver/definition relationships and world-generation invalidation | Exact relationships, menu/map transition, same-world generation stability, stale-generation refusal and zero capabilities | continuous `.6` proves map replacement + same-world stability; menu lifecycle transition pending |
