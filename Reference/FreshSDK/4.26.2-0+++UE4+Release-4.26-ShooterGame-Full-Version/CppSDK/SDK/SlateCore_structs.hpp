...
enum class EUINavigation : uint8
{
	...
	Up                                       = static_cast<uint8>(2),
	Down                                     = static_cast<uint8>(3),
	Next                                     = static_cast<uint8>(4),
	Previous                                 = static_cast<uint8>(5),
	Num                                      = static_cast<uint8>(6),
	Invalid                                  = static_cast<uint8>(7),
	EUINavigation_MAX                        = static_cast<uint8>(8),
};
...
{
	Unchecked                                = static_cast<uint8>(0),
	Checked                                  = static_cast<uint8>(1),
	Undetermined                             = static_cast<uint8>(2),
	ECheckBoxState_MAX                       = static_cast<uint8>(3),
};
...
{
	Inherit                                  = static_cast<uint8>(0),
	ClipToBounds                             = static_cast<uint8>(1),
	ClipToBoundsWithoutIntersecting          = static_cast<uint8>(2),
	ClipToBoundsAlways                       = static_cast<uint8>(3),
	OnDemand                                 = static_cast<uint8>(4),
	ClipNever                                = static_cast<uint8>(5),
	EWidgetClipping_MAX                      = static_cast<uint8>(6),
};
...
{
	NoImage                                  = static_cast<uint8>(0),
	FullColor                                = static_cast<uint8>(1),
	Linear                                   = static_cast<uint8>(2),
	ESlateBrushImageType_MAX                 = static_cast<uint8>(3),
};
...
{
	NoMirror                                 = static_cast<uint8>(0),
	Horizontal                               = static_cast<uint8>(1),
	Vertical                                 = static_cast<uint8>(2),
	Both                                     = static_cast<uint8>(3),
	ESlateBrushMirrorType_MAX                = static_cast<uint8>(4),
};
...
{
	NoTile                                   = static_cast<uint8>(0),
	Horizontal                               = static_cast<uint8>(1),
	Vertical                                 = static_cast<uint8>(2),
	Both                                     = static_cast<uint8>(3),
	ESlateBrushTileType_MAX                  = static_cast<uint8>(4),
};
...
{
	NoDrawType                               = static_cast<uint8>(0),
	Box                                      = static_cast<uint8>(1),
	Border                                   = static_cast<uint8>(2),
	Image                                    = static_cast<uint8>(3),
	ESlateBrushDrawType_MAX                  = static_cast<uint8>(4),
};
...
{
	UseColor_Specified                       = static_cast<uint8>(0),
	UseColor_Specified_Link                  = static_cast<uint8>(1),
	UseColor_Foreground                      = static_cast<uint8>(2),
	UseColor_Foreground_Subdued              = static_cast<uint8>(3),
	UseColor_MAX                             = static_cast<uint8>(4),
};
...
{
	Escape                                   = static_cast<uint8>(0),
	Explicit                                 = static_cast<uint8>(1),
	Wrap                                     = static_cast<uint8>(2),
	Stop                                     = static_cast<uint8>(3),
	Custom                                   = static_cast<uint8>(4),
	CustomBoundary                           = static_cast<uint8>(5),
	Invalid                                  = static_cast<uint8>(6),
	EUINavigationRule_MAX                    = static_cast<uint8>(7),
};
...
{
	Orient_Horizontal                        = static_cast<uint8>(0),
	Orient_Vertical                          = static_cast<uint8>(1),
	Orient_MAX                               = static_cast<uint8>(2),
};
...
{
	Inherit                                  = static_cast<uint8>(0),
	Culture                                  = static_cast<uint8>(1),
	LeftToRight                              = static_cast<uint8>(2),
	RightToLeft                              = static_cast<uint8>(3),
	EFlowDirectionPreference_MAX             = static_cast<uint8>(4),
};
...
{
	NormalVision                             = static_cast<uint8>(0),
	Deuteranope                              = static_cast<uint8>(1),
	Protanope                                = static_cast<uint8>(2),
	Tritanope                                = static_cast<uint8>(3),
	EColorVisionDeficiency_MAX               = static_cast<uint8>(4),
};
...
{
	OnKeyPress                               = static_cast<uint8>(0),
	OnNavigation                             = static_cast<uint8>(1),
	OnMouseClick                             = static_cast<uint8>(2),
	Direct                                   = static_cast<uint8>(3),
	ESelectInfo_MAX                          = static_cast<uint8>(4),
};
...
enum class ETextCommit : uint8
{
	...
	OnEnter                                  = static_cast<uint8>(1),
	OnUserMovedFocus                         = static_cast<uint8>(2),
	OnCleared                                = static_cast<uint8>(3),
	ETextCommit_MAX                          = static_cast<uint8>(4),
};
...
enum class ETextShapingMethod : uint8
{
	...
	KerningOnly                              = static_cast<uint8>(1),
	FullShaping                              = static_cast<uint8>(2),
	ETextShapingMethod_MAX                   = static_cast<uint8>(3),
};
...
{
	MenuPlacement_BelowAnchor                = static_cast<uint8>(0),
	MenuPlacement_CenteredBelowAnchor        = static_cast<uint8>(1),
	MenuPlacement_BelowRightAnchor           = static_cast<uint8>(2),
	MenuPlacement_ComboBox                   = static_cast<uint8>(3),
	MenuPlacement_ComboBoxRight              = static_cast<uint8>(4),
	MenuPlacement_MenuRight                  = static_cast<uint8>(5),
	MenuPlacement_AboveAnchor                = static_cast<uint8>(6),
	MenuPlacement_CenteredAboveAnchor        = static_cast<uint8>(7),
	MenuPlacement_AboveRightAnchor           = static_cast<uint8>(8),
	MenuPlacement_MenuLeft                   = static_cast<uint8>(9),
	MenuPlacement_Center                     = static_cast<uint8>(10),
	MenuPlacement_RightLeftCenter            = static_cast<uint8>(11),
	MenuPlacement_MatchBottomLeft            = static_cast<uint8>(12),
	MenuPlacement_MAX                        = static_cast<uint8>(13),
};
...
{
	Metrics                                  = static_cast<uint8>(0),
	BoundingBox                              = static_cast<uint8>(1),
	EFontLayoutMethod_MAX                    = static_cast<uint8>(2),
};
...
{
	LazyLoad                                 = static_cast<uint8>(0),
	Stream                                   = static_cast<uint8>(1),
	Inline                                   = static_cast<uint8>(2),
	EFontLoadingPolicy_MAX                   = static_cast<uint8>(3),
};
...
enum class EFontHinting : uint8
{
	...
	AutoLight                                = static_cast<uint8>(2),
	Monochrome                               = static_cast<uint8>(3),
	None                                     = static_cast<uint8>(4),
	EFontHinting_MAX                         = static_cast<uint8>(5),
};
...
{
	Mouse                                    = static_cast<uint8>(0),
	Navigation                               = static_cast<uint8>(1),
	SetDirectly                              = static_cast<uint8>(2),
	Cleared                                  = static_cast<uint8>(3),
	OtherWidgetLostFocus                     = static_cast<uint8>(4),
	WindowActivate                           = static_cast<uint8>(5),
	EFocusCause_MAX                          = static_cast<uint8>(6),
};
...
{
	FocusChanging                            = static_cast<uint8>(0),
	FocusLost                                = static_cast<uint8>(1),
	FocusReceived                            = static_cast<uint8>(2),
...
enum class ESlateDebuggingNavigationMethod : uint8
{
	...
	Explicit                                 = static_cast<uint8>(1),
	CustomDelegateBound                      = static_cast<uint8>(2),
	CustomDelegateUnbound                    = static_cast<uint8>(3),
	NextOrPrevious                           = static_cast<uint8>(4),
	HitTestGrid                              = static_cast<uint8>(5),
	ESlateDebuggingNavigationMethod_MAX      = static_cast<uint8>(6),
};
...
{
	MouseCaptureGained                       = static_cast<uint8>(0),
	MouseCaptureLost                         = static_cast<uint8>(1),
	ESlateDebuggingStateChangeEvent_MAX      = static_cast<uint8>(2),
};
...
{
	MouseMove                                = static_cast<uint8>(0),
	MouseEnter                               = static_cast<uint8>(1),
	MouseLeave                               = static_cast<uint8>(2),
	PreviewMouseButtonDown                   = static_cast<uint8>(3),
	MouseButtonDown                          = static_cast<uint8>(4),
	MouseButtonUp                            = static_cast<uint8>(5),
	MouseButtonDoubleClick                   = static_cast<uint8>(6),
	MouseWheel                               = static_cast<uint8>(7),
	TouchStart                               = static_cast<uint8>(8),
	TouchEnd                                 = static_cast<uint8>(9),
	TouchForceChanged                        = static_cast<uint8>(10),
	TouchFirstMove                           = static_cast<uint8>(11),
	TouchMoved                               = static_cast<uint8>(12),
	DragDetected                             = static_cast<uint8>(13),
	DragEnter                                = static_cast<uint8>(14),
	DragLeave                                = static_cast<uint8>(15),
	DragOver                                 = static_cast<uint8>(16),
	DragDrop                                 = static_cast<uint8>(17),
	DropMessage                              = static_cast<uint8>(18),
	PreviewKeyDown                           = static_cast<uint8>(19),
	KeyDown                                  = static_cast<uint8>(20),
	KeyUp                                    = static_cast<uint8>(21),
	KeyChar                                  = static_cast<uint8>(22),
	AnalogInput                              = static_cast<uint8>(23),
	TouchGesture                             = static_cast<uint8>(24),
	MotionDetected                           = static_cast<uint8>(25),
	MAX                                      = static_cast<uint8>(26),
};
...
{
	Scroll_Down                              = static_cast<uint8>(0),
	Scroll_Up                                = static_cast<uint8>(1),
	Scroll_MAX                               = static_cast<uint8>(2),
};
...
{
	VAlign_Fill                              = static_cast<uint8>(0),
	VAlign_Top                               = static_cast<uint8>(1),
	VAlign_Center                            = static_cast<uint8>(2),
	VAlign_Bottom                            = static_cast<uint8>(3),
	VAlign_MAX                               = static_cast<uint8>(4),
};
...
{
	HAlign_Fill                              = static_cast<uint8>(0),
	HAlign_Left                              = static_cast<uint8>(1),
	HAlign_Center                            = static_cast<uint8>(2),
	HAlign_Right                             = static_cast<uint8>(3),
	HAlign_MAX                               = static_cast<uint8>(4),
};
...
{
	Keyboard                                 = static_cast<uint8>(0),
	Controller                               = static_cast<uint8>(1),
	User                                     = static_cast<uint8>(2),
	ENavigationGenesis_MAX                   = static_cast<uint8>(3),
};
...
{
	FocusedWidget                            = static_cast<uint8>(0),
	WidgetUnderCursor                        = static_cast<uint8>(1),
	ENavigationSource_MAX                    = static_cast<uint8>(2),
};
...
{
	Accept                                   = static_cast<uint8>(0),
	Back                                     = static_cast<uint8>(1),
	Num                                      = static_cast<uint8>(2),
	Invalid                                  = static_cast<uint8>(3),
	EUINavigationAction_MAX                  = static_cast<uint8>(4),
};
...
{
	DownAndUp                                = static_cast<uint8>(0),
	ButtonPress                              = static_cast<uint8>(1),
	ButtonRelease                            = static_cast<uint8>(2),
	EButtonPressMethod_MAX                   = static_cast<uint8>(3),
};
...
enum class EButtonTouchMethod : uint8
{
	...
	PreciseTap                               = static_cast<uint8>(2),
	EButtonTouchMethod_MAX                   = static_cast<uint8>(3),
};
...
{
	DownAndUp                                = static_cast<uint8>(0),
	MouseDown                                = static_cast<uint8>(1),
	MouseUp                                  = static_cast<uint8>(2),
	PreciseClick                             = static_cast<uint8>(3),
	EButtonClickMethod_MAX                   = static_cast<uint8>(4),
};
...
{
	CheckBox                                 = static_cast<uint8>(0),
	ToggleButton                             = static_cast<uint8>(1),
	ESlateCheckBoxType_MAX                   = static_cast<uint8>(2),
};
...
{
	ActiveWindow                             = static_cast<uint8>(0),
	MainWindow                               = static_cast<uint8>(1),
	ESlateParentWindowSearchMethod_MAX       = static_cast<uint8>(2),
};
...
{
	WhenScrollingPossible                    = static_cast<uint8>(0),
	Always                                   = static_cast<uint8>(1),
	Never                                    = static_cast<uint8>(2),
	EConsumeMouseWheel_MAX                   = static_cast<uint8>(3),
};
