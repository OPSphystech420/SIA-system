...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05D434E8;
	constexpr int32 AppendString      = 0x00000000;
	constexpr int32 GNames            = 0x05BB5180;
	constexpr int32 GWorld            = 0x05DBA4F0;
	constexpr int32 ProcessEvent      = 0x0250147C;
...
{
public:
	int32                                         Id;                                                // 0x0000(0x0004)(NOT AUTO-GENERATED PROPERTY)
...
public:
	...
	TCHAR                                         WideName[0x400];                                   // 0x0000(0x0002)(NOT AUTO-GENERATED PROPERTY)
};
...
{
public:
	static constexpr auto DecryptName = [](uint8* RawEntryPtr) -> uint8*
	{
		return RawEntryPtr;
	};
	static constexpr auto DecryptString = [](std::string Decoded) -> std::string
	{
		return Decoded;
	};
...
// 0x100D0 (0x100D0 - 0x0000)
class FNamePool final
{
public:
	static constexpr auto DecryptNamePool = [](uintptr_t EncryptedNamePoolData) -> uintptr_t
	{
	...
	uint32                                        CurrentBlock;                                      // 0x00C8(0x0004)(NOT AUTO-GENERATED PROPERTY)
	uint32                                        CurrentByteCursor;                                 // 0x00CC(0x0004)(NOT AUTO-GENERATED PROPERTY)
	uint8*                                        Blocks[0x2000];                                    // 0x00D0(0x10000)(NOT AUTO-GENERATED PROPERTY)
...
{
public:
	int32                                         ArrayDim;                                          // 0x0034(0x0004)(NOT AUTO-GENERATED PROPERTY)
	int32                                         ElementSize;                                       // 0x0038(0x0004)(NOT AUTO-GENERATED PROPERTY)
