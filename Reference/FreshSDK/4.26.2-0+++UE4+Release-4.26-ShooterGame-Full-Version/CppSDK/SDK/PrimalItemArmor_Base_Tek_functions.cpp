...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UClass**                          ResolvedTekArmorBuff                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// class AShooterCharacter*                OwningPlayer                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UClass**                          TekArmorBuff                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UPrimalItemArmor_Base_Tek_C::TryToDecreaseElement(int32 AmountToDecreaseBy, bool* bSucceeded)
{
	static class UFunction* Func = nullptr;
