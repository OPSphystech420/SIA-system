...
void ABuff_TekArmor_Sword_C::MobileTargetingInputHack(bool bPressed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Buff_TekArmor_Sword_C", "MobileTargetingInputHack");

	Params::Buff_TekArmor_Sword_C_MobileTargetingInputHack Parms{};
...
void ABuff_TekArmor_Sword_C::Set_AudioParams_and_Play(class UAudioComponent*& Audio, float Volume, float Pitch, bool PlaySound)
{
	static class UFunction* Func = nullptr;
...
// bool                                    isForChargedState                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
// Parameters:
// class AShooterWeapon*                   Weapon                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool*                                   IsTekSword_0                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
