...
// float                                   ElementCostMultiplier                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AWeapSword_Tek_C::AppliedDamageToTarget(class AActor* DamageTarget, float ElementCostMultiplier, int32 DamageIn, bool* bExtraDamage)
{
	static class UFunction* Func = nullptr;
...
void AWeapSword_Tek_C::DoAppliedDamageToTarget(class AActor* DamageTarget, float ElementCostMultiplier, int32 DamageIn, bool* bExtraDamage)
{
	static class UFunction* Func = nullptr;
