...
// Parameters:
// bool                                    bIsTablet                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UUI_HelpPage_C::BPHandleTabletModeChange(bool bIsTablet)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_HelpPage_C", "BPHandleTabletModeChange");

	Params::UI_HelpPage_C_BPHandleTabletModeChange Parms{};

	Parms.bIsTablet = bIsTablet;
