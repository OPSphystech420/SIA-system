...
public:
	...
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x00E0(0x0090)(Protected, NativeAccessSpecifierProtected)
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"MovieSceneFloatDecomposer")
	}
...
public:
	...
	TMap<int32, struct FMovieSceneSequenceHierarchy> Hierarchies;                                    // 0x00F0(0x0050)(NativeAccessSpecifierPrivate)
	TMap<int32, struct FMovieSceneEvaluationTemplate> TrackTemplates;                                // 0x0140(0x0050)(ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TMap<int32, struct FMovieSceneEvaluationField> TrackTemplateFields;                              // 0x0190(0x0050)(NativeAccessSpecifierPrivate)
	TMap<int32, struct FMovieSceneEntityComponentField> EntityComponentFields;                       // 0x01E0(0x0050)(NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                         bReversePlayback : 1;                              // 0x0461(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Net, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
