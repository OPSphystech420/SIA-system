...
enum class EMovieSceneKeyInterpolation : uint8
{
	...
	User                                     = static_cast<uint8>(1),
	Break                                    = static_cast<uint8>(2),
	Linear                                   = static_cast<uint8>(3),
	Constant                                 = static_cast<uint8>(4),
	EMovieSceneKeyInterpolation_MAX          = static_cast<uint8>(5),
};
...
enum class EMovieSceneBlendType : uint8
{
	...
	Absolute                                 = static_cast<uint8>(1),
	Additive                                 = static_cast<uint8>(2),
	Relative                                 = static_cast<uint8>(4),
	AdditiveFromBase                         = static_cast<uint8>(8),
	EMovieSceneBlendType_MAX                 = static_cast<uint8>(9),
};
...
{
	KeepState                                = static_cast<uint8>(0),
	RestoreState                             = static_cast<uint8>(1),
	ProjectDefault                           = static_cast<uint8>(2),
	EMovieSceneCompletionMode_MAX            = static_cast<uint8>(3),
};
...
enum class EMovieSceneBuiltInEasing : uint8
{
	...
	SinIn                                    = static_cast<uint8>(1),
	SinOut                                   = static_cast<uint8>(2),
	SinInOut                                 = static_cast<uint8>(3),
	QuadIn                                   = static_cast<uint8>(4),
	QuadOut                                  = static_cast<uint8>(5),
	QuadInOut                                = static_cast<uint8>(6),
	CubicIn                                  = static_cast<uint8>(7),
	CubicOut                                 = static_cast<uint8>(8),
	CubicInOut                               = static_cast<uint8>(9),
	QuartIn                                  = static_cast<uint8>(10),
	QuartOut                                 = static_cast<uint8>(11),
	QuartInOut                               = static_cast<uint8>(12),
	QuintIn                                  = static_cast<uint8>(13),
	QuintOut                                 = static_cast<uint8>(14),
	QuintInOut                               = static_cast<uint8>(15),
	ExpoIn                                   = static_cast<uint8>(16),
	ExpoOut                                  = static_cast<uint8>(17),
	ExpoInOut                                = static_cast<uint8>(18),
	CircIn                                   = static_cast<uint8>(19),
	CircOut                                  = static_cast<uint8>(20),
	CircInOut                                = static_cast<uint8>(21),
	EMovieSceneBuiltInEasing_MAX             = static_cast<uint8>(22),
};
...
{
	Static                                   = static_cast<uint8>(0),
	Swept                                    = static_cast<uint8>(1),
	EEvaluationMethod_MAX                    = static_cast<uint8>(2),
};
...
enum class EMovieSceneSequenceFlags : uint8
{
	...
	Volatile                                 = static_cast<uint8>(1),
	BlockingEvaluation                       = static_cast<uint8>(2),
	InheritedFlags                           = static_cast<uint8>(1),
	EMovieSceneSequenceFlags_MAX             = static_cast<uint8>(3),
};
...
{
	Tick                                     = static_cast<uint8>(0),
	Platform                                 = static_cast<uint8>(1),
	Audio                                    = static_cast<uint8>(2),
	RelativeTimecode                         = static_cast<uint8>(3),
	Timecode                                 = static_cast<uint8>(4),
	Custom                                   = static_cast<uint8>(5),
	EUpdateClockSource_MAX                   = static_cast<uint8>(6),
};
...
{
	FrameLocked                              = static_cast<uint8>(0),
	WithSubFrames                            = static_cast<uint8>(1),
	EMovieSceneEvaluationType_MAX            = static_cast<uint8>(2),
};
...
{
	Stopped                                  = static_cast<uint8>(0),
	Playing                                  = static_cast<uint8>(1),
	Recording                                = static_cast<uint8>(2),
	Scrubbing                                = static_cast<uint8>(3),
	Jumping                                  = static_cast<uint8>(4),
	Stepping                                 = static_cast<uint8>(5),
	Paused                                   = static_cast<uint8>(6),
...
enum class EMovieSceneObjectBindingSpace : uint8
{
	...
	Root                                     = static_cast<uint8>(1),
	EMovieSceneObjectBindingSpace_MAX        = static_cast<uint8>(2),
};
...
{
	None                                     = static_cast<uint8>(0),
	PreRoll                                  = static_cast<uint8>(1),
	PostRoll                                 = static_cast<uint8>(2),
	ESectionEvaluationFlags_MAX              = static_cast<uint8>(3),
};
...
{
	Frame                                    = static_cast<uint8>(0),
	Time                                     = static_cast<uint8>(1),
	MarkedFrame                              = static_cast<uint8>(2),
	EMovieScenePositionType_MAX              = static_cast<uint8>(3),
};
...
{
	Play                                     = static_cast<uint8>(0),
	Jump                                     = static_cast<uint8>(1),
	Scrub                                    = static_cast<uint8>(2),
	EUpdatePositionMethod_MAX                = static_cast<uint8>(3),
};
...
{
	InnerSequence                            = static_cast<uint8>(0),
	MasterSequence                           = static_cast<uint8>(1),
	External                                 = static_cast<uint8>(2),
	ESpawnOwnership_MAX                      = static_cast<uint8>(3),
};
