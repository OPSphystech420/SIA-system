...
{
	Legacy                                   = static_cast<uint8>(0),
	Accurate                                 = static_cast<uint8>(1),
	EClothingWindMethod_MAX                  = static_cast<uint8>(2),
};
...
enum class EWeightMapTargetCommon : uint8
{
	...
	MaxDistance                              = static_cast<uint8>(1),
	BackstopDistance                         = static_cast<uint8>(2),
	BackstopRadius                           = static_cast<uint8>(3),
	AnimDriveMultiplier                      = static_cast<uint8>(4),
	EWeightMapTargetCommon_MAX               = static_cast<uint8>(5),
};
