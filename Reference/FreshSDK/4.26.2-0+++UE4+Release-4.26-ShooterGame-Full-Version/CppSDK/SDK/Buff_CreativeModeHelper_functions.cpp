...
// Parameters:
// bool                                    IsFlying_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
// (Net, NetReliable, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APrimalStructure*                 StructureToDestroy                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABuff_CreativeModeHelper_C::InpActEvt_ArkGamepadLeftShoulder_K2Node_InputActionEvent_0(const struct FKey& Key)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Buff_CreativeModeHelper_C", "InpActEvt_ArkGamepadLeftShoulder_K2Node_InputActionEvent_0");

	Params::Buff_CreativeModeHelper_C_InpActEvt_ArkGamepadLeftShoulder_K2Node_InputActionEvent_0 Parms{};
...
void ABuff_CreativeModeHelper_C::InpActEvt_Run_K2Node_InputActionEvent_2(const struct FKey& Key)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Buff_CreativeModeHelper_C", "InpActEvt_Run_K2Node_InputActionEvent_2");

	Params::Buff_CreativeModeHelper_C_InpActEvt_Run_K2Node_InputActionEvent_2 Parms{};
...
void ABuff_CreativeModeHelper_C::InpActEvt_Jump_K2Node_InputActionEvent_4(const struct FKey& Key)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Buff_CreativeModeHelper_C", "InpActEvt_Jump_K2Node_InputActionEvent_4");

	Params::Buff_CreativeModeHelper_C_InpActEvt_Jump_K2Node_InputActionEvent_4 Parms{};
