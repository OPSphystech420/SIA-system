...
{
	Translation                              = static_cast<uint8>(0),
	Rotation                                 = static_cast<uint8>(1),
	Scale                                    = static_cast<uint8>(2),
	Parent                                   = static_cast<uint8>(3),
	ETransformConstraintType_MAX             = static_cast<uint8>(4),
};
...
{
	Transform                                = static_cast<uint8>(0),
	Aim                                      = static_cast<uint8>(1),
...
public:
	...
	struct FVector                                LookUpTarget;                                      // 0x0030(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
