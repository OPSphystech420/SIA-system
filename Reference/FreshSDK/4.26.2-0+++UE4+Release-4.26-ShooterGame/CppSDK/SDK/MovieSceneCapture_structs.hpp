...
{
	HCGM_Rec709                              = static_cast<uint8>(0),
	HCGM_P3DCI                               = static_cast<uint8>(1),
	HCGM_Rec2020                             = static_cast<uint8>(2),
	HCGM_ACES                                = static_cast<uint8>(3),
	HCGM_ACEScg                              = static_cast<uint8>(4),
	HCGM_Linear                              = static_cast<uint8>(5),
	HCGM_MAX                                 = static_cast<uint8>(6),
};
...
enum class EMovieSceneCaptureProtocolState : uint8
{
	...
	Initialized                              = static_cast<uint8>(1),
	Capturing                                = static_cast<uint8>(2),
	Finalizing                               = static_cast<uint8>(3),
	EMovieSceneCaptureProtocolState_MAX      = static_cast<uint8>(4),
};
