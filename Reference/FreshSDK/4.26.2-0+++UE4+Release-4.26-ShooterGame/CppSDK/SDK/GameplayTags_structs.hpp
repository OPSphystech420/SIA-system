...
enum class EGameplayTagQueryExprType : uint8
{
	...
	AnyTagsMatch                             = static_cast<uint8>(1),
	AllTagsMatch                             = static_cast<uint8>(2),
	NoTagsMatch                              = static_cast<uint8>(3),
	AnyExprMatch                             = static_cast<uint8>(4),
	AllExprMatch                             = static_cast<uint8>(5),
	NoExprMatch                              = static_cast<uint8>(6),
	EGameplayTagQueryExprType_MAX            = static_cast<uint8>(7),
};
...
{
	Any                                      = static_cast<uint8>(0),
	All                                      = static_cast<uint8>(1),
	EGameplayContainerMatchType_MAX          = static_cast<uint8>(2),
};
...
{
	Explicit                                 = static_cast<uint8>(0),
	IncludeParentTags                        = static_cast<uint8>(1),
	EGameplayTagMatchType_MAX                = static_cast<uint8>(2),
};
...
enum class EGameplayTagSelectionType : uint8
{
	...
	NonRestrictedOnly                        = static_cast<uint8>(1),
	RestrictedOnly                           = static_cast<uint8>(2),
	All                                      = static_cast<uint8>(3),
	EGameplayTagSelectionType_MAX            = static_cast<uint8>(4),
};
...
{
	Native                                   = static_cast<uint8>(0),
	DefaultTagList                           = static_cast<uint8>(1),
	TagList                                  = static_cast<uint8>(2),
	RestrictedTagList                        = static_cast<uint8>(3),
	DataTable                                = static_cast<uint8>(4),
	Invalid                                  = static_cast<uint8>(5),
	EGameplayTagSourceType_MAX               = static_cast<uint8>(6),
};
