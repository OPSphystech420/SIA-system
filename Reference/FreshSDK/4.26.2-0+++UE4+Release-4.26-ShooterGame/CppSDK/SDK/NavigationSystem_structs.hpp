...
enum class ERuntimeGenerationType : uint8
{
	...
	DynamicModifiersOnly                     = static_cast<uint8>(1),
	Dynamic                                  = static_cast<uint8>(2),
	LegacyGeneration                         = static_cast<uint8>(3),
	ERuntimeGenerationType_MAX               = static_cast<uint8>(4),
};
...
{
	TotalCost                                = static_cast<uint8>(0),
	HeuristicOnly                            = static_cast<uint8>(1),
	RealCostOnly                             = static_cast<uint8>(2),
	ENavCostDisplay_MAX                      = static_cast<uint8>(3),
};
...
{
	Override                                 = static_cast<uint8>(0),
	Append                                   = static_cast<uint8>(1),
	Skip                                     = static_cast<uint8>(2),
	ENavSystemOverridePolicy_MAX             = static_cast<uint8>(3),
};
...
{
	Monotone                                 = static_cast<uint8>(0),
	Watershed                                = static_cast<uint8>(1),
	ChunkyMonotone                           = static_cast<uint8>(2),
	ERecastPartitioning_MAX                  = static_cast<uint8>(3),
};
