...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"VariantObjectBinding")
	}
...
public:
	...
	class USceneComponent*                        SceneComponent;                                    // 0x03F0(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         LastSelectedOption;                                // 0x03F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"SwitchActor")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"PropertyValue")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"PropertyValueSoftObject")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"PropertyValueOption")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"PropertyValueMaterial")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"PropertyValueColor")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"PropertyValueVisibility")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"PropertyValueTransform")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"LevelVariantSetsFunctionDirector")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"LevelVariantSetsActor")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"LevelVariantSets")
	}
