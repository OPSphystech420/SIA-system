...
{
	Inner                                    = static_cast<uint8>(0),
	Outer                                    = static_cast<uint8>(1),
	ESphericalLimitType_MAX                  = static_cast<uint8>(2),
};
...
{
	Component                                = static_cast<uint8>(0),
	Actor                                    = static_cast<uint8>(1),
	World                                    = static_cast<uint8>(2),
	RootRelative                             = static_cast<uint8>(3),
	BoneRelative                             = static_cast<uint8>(4),
	AnimPhysSimSpaceType_MAX                 = static_cast<uint8>(5),
};
...
{
	Free                                     = static_cast<uint8>(0),
	Limited                                  = static_cast<uint8>(1),
	AnimPhysLinearConstraintType_MAX         = static_cast<uint8>(2),
};
...
{
	Angular                                  = static_cast<uint8>(0),
	Cone                                     = static_cast<uint8>(1),
	AnimPhysAngularConstraintType_MAX        = static_cast<uint8>(2),
};
...
{
	StandardBlend                            = static_cast<uint8>(0),
	Inertialization                          = static_cast<uint8>(1),
	EBlendListTransitionType_MAX             = static_cast<uint8>(2),
};
...
{
	Bone                                     = static_cast<uint8>(0),
	MorphTarget                              = static_cast<uint8>(1),
	MaterialParameter                        = static_cast<uint8>(2),
	EDrivenDestinationMode_MAX               = static_cast<uint8>(3),
};
...
{
	AddToInput                               = static_cast<uint8>(0),
	ReplaceComponent                         = static_cast<uint8>(1),
	AddToRefPose                             = static_cast<uint8>(2),
	EDrivenBoneModificationMode_MAX          = static_cast<uint8>(3),
};
...
enum class EConstraintOffsetOption : uint8
{
	...
	Offset_RefPose                           = static_cast<uint8>(1),
	EConstraintOffsetOption_MAX              = static_cast<uint8>(2),
};
...
{
	Accumulate                               = static_cast<uint8>(0),
	Copy                                     = static_cast<uint8>(1),
	CopyBoneDeltaMode_MAX                    = static_cast<uint8>(2),
};
...
enum class EInterpolationBlend : uint8
{
	...
	Cubic                                    = static_cast<uint8>(1),
	Sinusoidal                               = static_cast<uint8>(2),
	EaseInOutExponent2                       = static_cast<uint8>(3),
	EaseInOutExponent3                       = static_cast<uint8>(4),
	EaseInOutExponent4                       = static_cast<uint8>(5),
	EaseInOutExponent5                       = static_cast<uint8>(6),
...
{
	BMM_Ignore                               = static_cast<uint8>(0),
	BMM_Replace                              = static_cast<uint8>(1),
	BMM_Additive                             = static_cast<uint8>(2),
	BMM_MAX                                  = static_cast<uint8>(3),
};
...
{
	Add                                      = static_cast<uint8>(0),
	Scale                                    = static_cast<uint8>(1),
	Blend                                    = static_cast<uint8>(2),
	WeightedMovingAverage                    = static_cast<uint8>(3),
	RemapCurve                               = static_cast<uint8>(4),
	EModifyCurveApplyMode_MAX                = static_cast<uint8>(5),
};
...
{
	DrivePoses                               = static_cast<uint8>(0),
	DriveCurves                              = static_cast<uint8>(1),
	EPoseDriverOutput_MAX                    = static_cast<uint8>(2),
};
...
{
	Rotation                                 = static_cast<uint8>(0),
	Translation                              = static_cast<uint8>(1),
	EPoseDriverSource_MAX                    = static_cast<uint8>(2),
};
...
{
	SwingAndTwist                            = static_cast<uint8>(0),
	SwingOnly                                = static_cast<uint8>(1),
	Translation                              = static_cast<uint8>(2),
	EPoseDriverType_MAX                      = static_cast<uint8>(3),
};
...
{
	NamedSnapshot                            = static_cast<uint8>(0),
	SnapshotPin                              = static_cast<uint8>(1),
	ESnapshotSourceMode_MAX                  = static_cast<uint8>(2),
};
...
{
	EIT_LocalSpace                           = static_cast<uint8>(0),
	EIT_Additive                             = static_cast<uint8>(1),
	EIT_MAX                                  = static_cast<uint8>(2),
};
...
{
	ComponentSpace                           = static_cast<uint8>(0),
	WorldSpace                               = static_cast<uint8>(1),
	BaseBoneSpace                            = static_cast<uint8>(2),
	ESimulationSpace_MAX                     = static_cast<uint8>(3),
};
...
{
	FixedDefaultLengthValue                  = static_cast<uint8>(0),
	Distance                                 = static_cast<uint8>(1),
	ChainLength                              = static_cast<uint8>(2),
	EScaleChainInitialLength_MAX             = static_cast<uint8>(3),
};
...
{
	NoReset                                  = static_cast<uint8>(0),
	StartPosition                            = static_cast<uint8>(1),
	ExplicitTime                             = static_cast<uint8>(2),
	ESequenceEvalReinit_MAX                  = static_cast<uint8>(3),
};
...
enum class ESplineBoneAxis : uint8
{
	...
	ESplineBoneAxis_MAX                      = static_cast<uint8>(4),
};
...
{
	EulerX                                   = static_cast<uint8>(0),
	EulerY                                   = static_cast<uint8>(1),
	EulerZ                                   = static_cast<uint8>(2),
	QuaternionAngle                          = static_cast<uint8>(3),
	SwingAngle                               = static_cast<uint8>(4),
	TwistAngle                               = static_cast<uint8>(5),
	ERotationComponent_MAX                   = static_cast<uint8>(6),
};
...
{
	Linear                                   = static_cast<uint8>(0),
	Sinusoidal                               = static_cast<uint8>(1),
	Cubic                                    = static_cast<uint8>(2),
	QuadraticInOut                           = static_cast<uint8>(3),
	CubicInOut                               = static_cast<uint8>(4),
	HermiteCubic                             = static_cast<uint8>(5),
	QuarticInOut                             = static_cast<uint8>(6),
	QuinticInOut                             = static_cast<uint8>(7),
	CircularIn                               = static_cast<uint8>(8),
	CircularOut                              = static_cast<uint8>(9),
	CircularInOut                            = static_cast<uint8>(10),
	ExpIn                                    = static_cast<uint8>(11),
	ExpOut                                   = static_cast<uint8>(12),
	ExpInOut                                 = static_cast<uint8>(13),
	CustomCurve                              = static_cast<uint8>(14),
	EEasingFuncType_MAX                      = static_cast<uint8>(15),
};
...
{
	OnlyNormalizeAboveOne                    = static_cast<uint8>(0),
	AlwaysNormalize                          = static_cast<uint8>(1),
	NormalizeWithinMedian                    = static_cast<uint8>(2),
	NoNormalization                          = static_cast<uint8>(3),
	ERBFNormalizeMethod_MAX                  = static_cast<uint8>(4),
};
...
{
	Euclidean                                = static_cast<uint8>(0),
	Quaternion                               = static_cast<uint8>(1),
	SwingAngle                               = static_cast<uint8>(2),
	TwistAngle                               = static_cast<uint8>(3),
	DefaultMethod                            = static_cast<uint8>(4),
	ERBFDistanceMethod_MAX                   = static_cast<uint8>(5),
};
...
{
	Gaussian                                 = static_cast<uint8>(0),
	Exponential                              = static_cast<uint8>(1),
	Linear                                   = static_cast<uint8>(2),
	Cubic                                    = static_cast<uint8>(3),
	Quintic                                  = static_cast<uint8>(4),
	DefaultFunction                          = static_cast<uint8>(5),
	ERBFFunctionType_MAX                     = static_cast<uint8>(6),
};
...
enum class ERBFSolverType : uint8
{
	...
	Interpolative                            = static_cast<uint8>(1),
	ERBFSolverType_MAX                       = static_cast<uint8>(2),
};
...
{
public:
	float                                         X;                                                 // 0x0034(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Y;                                                 // 0x0038(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Z;                                                 // 0x003C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bLoop;                                             // 0x0044(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bResetPlayTimeWhenBlendSpaceChanges;               // 0x0045(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTransform                             BoneTransform;                                     // 0x0110(0x0030)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bUseRotationTransform;                             // 0x0140(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIgnoreOnDedicatedServer;                          // 0x0141(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowUpdatingOutsideOfGameWorld;                  // 0x0142(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
