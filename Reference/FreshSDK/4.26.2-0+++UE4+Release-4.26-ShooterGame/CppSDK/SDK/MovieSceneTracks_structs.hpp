...
enum class EMovieScene3DPathSection_Axis : uint8
{
	...
	Z                                        = static_cast<uint8>(2),
	NEG_X                                    = static_cast<uint8>(3),
	NEG_Y                                    = static_cast<uint8>(4),
	NEG_Z                                    = static_cast<uint8>(5),
	MovieScene3DPathSection_MAX              = static_cast<uint8>(6),
};
...
{
	AtStartOfEvaluation                      = static_cast<uint8>(0),
	AtEndOfEvaluation                        = static_cast<uint8>(1),
	AfterSpawn                               = static_cast<uint8>(2),
	EFireEventsAtPosition_MAX                = static_cast<uint8>(3),
};
...
enum class ELevelVisibility : uint8
{
	...
	Hidden                                   = static_cast<uint8>(1),
	ELevelVisibility_MAX                     = static_cast<uint8>(2),
};
...
{
	Activate                                 = static_cast<uint8>(0),
	Deactivate                               = static_cast<uint8>(1),
	Trigger                                  = static_cast<uint8>(2),
	EParticleKey_MAX                         = static_cast<uint8>(3),
};
...
{
public:
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x0030(0x0090)(Protected, NativeAccessSpecifierProtected)
};
...
public:
	...
	struct FMovieSceneFloatChannel                SlomoCurve;                                        // 0x0018(0x00A0)(NativeAccessSpecifierPrivate)
};
...
{
public:
	struct FFrameNumber                           SectionStartTime;                                  // 0x00D4(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                           SectionEndTime;                                    // 0x00D8(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSkeletalAnimationSectionTemplateParameters Params;                             // 0x0018(0x00E0)(NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMovieSceneByteChannel                 ByteCurve;                                         // 0x0030(0x0098)(Protected, NativeAccessSpecifierProtected)
};
...
{
public:
	struct FMovieSceneByteChannel                 EnumCurve;                                         // 0x0030(0x0098)(Protected, NativeAccessSpecifierProtected)
};
...
{
public:
	struct FMovieSceneIntegerChannel              IntegerCurve;                                      // 0x0030(0x0090)(Protected, NativeAccessSpecifierProtected)
	EMovieSceneBlendType                          BlendType;                                         // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	struct FMovieSceneStringChannel               StringCurve;                                       // 0x0030(0x00A0)(Protected, NativeAccessSpecifierProtected)
};
...
{
public:
	struct FMovieSceneFloatChannel                ComponentCurves[0x4];                              // 0x0030(0x00A0)(Protected, NativeAccessSpecifierProtected)
	int32                                         NumChannelsUsed;                                   // 0x02B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EMovieSceneBlendType                          BlendType;                                         // 0x02B4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	struct FMovieSceneObjectPathChannel           MaterialChannel;                                   // 0x0018(0x00C0)(NativeAccessSpecifierPrivate)
};
...
public:
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneParticleChannel             ParticleKeys;                                      // 0x0018(0x0098)(NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x0030(0x00C0)(NativeAccessSpecifierPrivate)
};
...
{
public:
	class UMaterialParameterCollection*           MPC;                                               // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
public:
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneFloatChannel                FadeCurve;                                         // 0x0018(0x00A0)(NativeAccessSpecifierPrivate)
	struct FLinearColor                           FadeColor;                                         // 0x00B8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bFadeAudio : 1;                                    // 0x00C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
public:
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneEventSectionData            EventData;                                         // 0x0018(0x0088)(NativeAccessSpecifierPublic)
	uint8                                         bFireEventsWhenForwards : 1;                       // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bFireEventsWhenBackwards : 1;                      // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
{
public:
	struct FMovieSceneFloatChannel                Curves[0x4];                                       // 0x0030(0x00A0)(NativeAccessSpecifierPublic)
	EMovieSceneBlendType                          BlendType;                                         // 0x02B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FFrameNumber                           SectionEndTime;                                    // 0x003C(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
public:
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieSceneAudioSection*                AudioSection;                                      // 0x0018(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x0030(0x00B0)(NativeAccessSpecifierPrivate)
};
...
public:
	...
	struct FMovieSceneFloatChannel                TimingCurve;                                       // 0x0030(0x00A0)(NativeAccessSpecifierPublic)
	EMovieScene3DPathSection_Axis                 FrontAxisEnum;                                     // 0x00D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMovieScene3DPathSection_Axis                 UpAxisEnum;                                        // 0x00D1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bFollow : 1;                                       // 0x00D2(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReverse : 1;                                      // 0x00D2(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bForceUpright : 1;                                 // 0x00D2(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
