...
{
	SimpleAndComplex                         = static_cast<uint8>(0),
	Simple                                   = static_cast<uint8>(1),
	Complex                                  = static_cast<uint8>(2),
	EWheelSweepType_MAX                      = static_cast<uint8>(3),
};
...
{
	LimitedSlip_4W                           = static_cast<uint8>(0),
	LimitedSlip_FrontDrive                   = static_cast<uint8>(1),
	LimitedSlip_RearDrive                    = static_cast<uint8>(2),
	Open_4W                                  = static_cast<uint8>(3),
	Open_FrontDrive                          = static_cast<uint8>(4),
	Open_RearDrive                           = static_cast<uint8>(5),
	EVehicleDifferential4W_MAX               = static_cast<uint8>(6),
};
