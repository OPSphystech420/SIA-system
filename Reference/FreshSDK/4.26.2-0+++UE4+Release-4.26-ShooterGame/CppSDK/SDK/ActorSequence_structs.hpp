...
{
	ContextActor                             = static_cast<uint8>(0),
	ExternalActor                            = static_cast<uint8>(1),
	Component                                = static_cast<uint8>(2),
	EActorSequenceObjectReferenceType_MAX    = static_cast<uint8>(3),
};
